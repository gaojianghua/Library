			...
			<view class="px-2 mt-3">
				<view class="d-flex a-center j-sb">
					...
					<u-icon :label="$t('更多')" labelPos="left" labelSize="26rpx" name="arrow-right"
						@click="chakangengduo('recomm')"></u-icon>
				</view>
			...
			<view class="px-2">
				<view class="d-flex a-center j-sb mt-3">
					...
					<u-icon label="更多" labelPos="left" labelSize="24rpx" name="arrow-right"
						@click="chakangengduo('news')"></u-icon>
				</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			get_detail(id) {
				uni.navigateTo({
					url: '/pages-child/novel-detail/index?id=' + id
				})
			},
			chakangengduo(i) {
				this.$tools.Navigate.navigateTo('/pages-child/novel-news/index', i)
			},
			grid_click(i) {
				let str = '/pages-child/novel-news/index'
				switch (i) {
					case 0:
						this.$tools.Navigate.navigateTo('/pages-child/ranking/index', 1)
						break;
					case 1:
						uni.navigateTo({
							url: '/pages-child/member-center/index?id=' + '2'
						})
						break;
					case 2:
						this.$tools.Navigate.navigateTo(str, 'news')
						break;
					case 3:
						this.$tools.Navigate.navigateTo(str, 'finish')
						break;
				}
			},
			search() {
				this.$tools.Navigate.navigateTo('/pages-child/search/index', 2)
			}
		},
		computed: {
			scrollStyle() {
